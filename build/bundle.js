...
var _database = __webpack_require__(331);

var _calendar = __webpack_require__(332);

var _Note = __webpack_require__(345);
...
var App = function () {
	function App() {
		...
		this.database = new _database.Data(this);
   ...
   ${this.el.innerHTML}`;*/
		...
		key: 'insertApp',
		value: function insertApp(container) {
		...
		value: function onBind(e) {
			...
			if (e.cellClick) {
				...
				this.el.querySelectorAll('.calendar__cell').forEach(function (cell) {
					//debugger;
		...
		key: 'onDisplaySubmit',
		value: function onDisplaySubmit(e) {
			console.log('Display', e);
			var year = this.calendar.titleYear;
			var month = this.calendar._curMonth;
			var num = this.calendar._curNum;
			var date = new Date();
		...
		key: 'onBackBtnClick',
		value: function onBackBtnClick(e) {
			e.preventDefault();

			var event = new Event('cellClick', { bubbles: true });
...
var Data = exports.Data = function () {
	...
	_createClass(Data, [{
		...
		key: 'getData',
		value: function getData(ref, cb) {
			var dataRef = this.dbase.ref(ref);
			dataRef.on('value', cb);
		}
	}]);
...
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }(); /* import {CalendarCell} from "../../components/calendarcell/CalendarCell";
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     import {CalendarRow} from "../../components/calendarrow/CalendarRow.js";*/


var _CalendarTable = __webpack_require__(333);
...
var Calendar = exports.Calendar = function () {
	...
	_createClass(Calendar, [{
		...
		value: function renderTable() {
			new _CalendarTable.CalendarTable(this.data).insertTable(this.el.querySelector('.table__cnt'));
		}
	}, {
		key: 'insertCalendar',
		value: function insertCalendar(container) {
			this.render();
			container.append(this.el);
		}
	}, {
		...
		value: function _setData() {
			...
			for (var i = 0; i < this._firstDayOfMonth; i += 1) {
				data.unshift('');
			}
			for (var _i = 0; _i < lastDay; _i += 1) {
				data.push('');
			}

			for (var _i2 = 0; _i2 < data.length; _i2 += 7) {
				mainData.push(data.slice(_i2, _i2 + 7));
			}
...
exports.CalendarTable = undefined;

var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();

var _CalendarRow = __webpack_require__(334);

__webpack_require__(341);

function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

var CalendarTable = exports.CalendarTable = function () {
	...
	_createClass(CalendarTable, [{
		...
		value: function render() {
			...
			if (title) {
				new _CalendarRow.CalendarRow(this.days, true).insertRow(this.el.querySelector('.table__inner-head'));
			} else {
				this.data.forEach(function (rowData) {
					new _CalendarRow.CalendarRow(rowData).insertRow(_this.el.querySelector('.table__inner-body'));
				});
			}
		}
	}, {
		key: 'insertTable',
		value: function insertTable(container) {
			this.render(true);
			this.render();
			container.append(this.el);
		}
...
exports.CalendarRow = undefined;

var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();

var _CalendarCell = __webpack_require__(335);

__webpack_require__(339);

function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

var CalendarRow = exports.CalendarRow = function () {
	function CalendarRow(data) {
	...
	_createClass(CalendarRow, [{
		...
		value: function render() {
			for (var i = 0; i < this.count; i += 1) {
				new _CalendarCell.CalendarCell(i, this.data[i]).insertCell(this.el);
			}
		}
	}, {
		key: 'insertRow',
		value: function insertRow(container) {
			this.render();
			container.append(this.el);
		}
	}]);
...
exports.CalendarCell = undefined;
...
var CalendarCell = exports.CalendarCell = function () {
	...
	_createClass(CalendarCell, [{
		...
		key: 'insertCell',
		value: function insertCell(container) {
			this.render();
			container.append(this.el);
		}
	}, {
...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!../../node_modules/css-loader/index.js!./calendarcell.css", function() {
			var newContent = require("!!../../node_modules/css-loader/index.js!./calendarcell.css");
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../node_modules/css-loader/index.js!./calendarrow.css", function() {
			var newContent = require("!!../../node_modules/css-loader/index.js!./calendarrow.css");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
// module
exports.push([module.i, ".tr-header {\r\n\tfont-weight: bold;\r\n}", ""]);
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../node_modules/css-loader/index.js!./calendartable.css", function() {
			var newContent = require("!!../../node_modules/css-loader/index.js!./calendartable.css");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
// module
exports.push([module.i, ".calendar__table {\r\n\twidth: 100%;\r\n\tmin-width: 270px;\r\n\tborder-collapse: collapse;\r\n\toverflow: hidden;\r\n}\r\n\r\n@media screen and (max-width: 600px) {\r\n\t.calendar__table thead {\r\n\t\tdisplay: none;\r\n\t}\r\n}", ""]);
...
// module
exports.push([module.i, ".calendar {\r\n float: left;\r\n transition: margin-left 200ms;\r\n width: 100%;\r\n}\r\n.calendar__cnt {\r\n\twidth: 95%;\r\n\tmax-width: 1000px;\r\n\tmargin: 0 auto;\r\n\tbox-shadow: inset 0 0 10px #7A4738FF;\r\n\tpadding: 10px 10px 30px 10px;\r\n}\r\n.calendar__title {\r\n /* border: 1rem solid #a9f7a9;\r\n border-radius: 20px */\r\n \t\r\n}\r\n.calendar__title .title__year {\r\n\tposition: relative;\r\n\twidth: 100%;\r\n\tdisplay: block;\r\n\tpadding: 0.6rem 0;\r\n\tfont-size: 5rem;\r\n\ttext-align: center;\r\n\tbackground: #D3D3D3FF;\r\n\tbox-shadow: 0 0 10px #7A4738FF;\r\n\tcolor: #7A4738FF;;\r\n}\r\n.calendar__title .title__year span {\r\n\tposition: relative;\r\n}\r\n\r\n.calendar__title .title__year span:before {\r\n\tcontent: attr(data-year);\r\n\tposition: absolute;\r\n\ttext-align: center;\r\n\tcolor: #DDD;\r\n\tleft: -2px;\r\n\twidth: inherit;\r\n}\r\n\r\n.calendar__title .title__month {\r\n\twidth: 100%;\r\n\tdisplay: block;\r\n\tpadding: 0.6rem 0;\r\n\tfont-size: 2.5rem;\r\n\ttext-align: center;\r\n}\r\n.calendar__title .title__month span {\r\n\tborder-bottom-left-radius: 10px;\r\n\tpadding: 0 20px;\r\n\tbox-shadow: 0 0 100px #7A4738FF;\r\n}\r\n.table__cnt {\r\n\t/* width: 100%; */\r\n\toverflow: auto;\r\n}\r\n\r\n.hidden-calendar {\r\n\t/* margin-left: -1999px; */\r\n}\r\n\r\n@media screen and (max-width: 600px) {\r\n\t.calendar__title {\r\n\t\twidth: 100%;\r\n\t\t/* display: inline-block; */\r\n\t}\r\n\t.calendar__title .title__year {\r\n\t\t\r\n\t\t/* width: 30%;\r\n\t\tdisplay: block; */\r\n\t\tfont-size: 3rem;\r\n\t\ttext-align: left;\r\n\t}\r\n\t.calendar__title .title__month {\r\n\t\t\r\n\t\t/* width: 70%;\r\n\t\tdisplay: block;\r\n\t\tpadding: 0.6rem 0; */\r\n\t\tfont-size: 1.5rem;\r\n\t\ttext-align: center;\r\n\t}\r\n}", ""]);
...
var _NoteInput = __webpack_require__(346);

var _NoteDisplay = __webpack_require__(349);
...
var Note = exports.Note = function () {
	function Note(data) {
		...
		this.data = data || [{ name: 'Первая заметка', text: 'Херачу компоненты без остановки!' }, { name: 'Вторая заметка', text: 'Остановите меня кто-нибудь!!!' }];

		this.input = new _NoteInput.NoteInput({ onSubmit: this.onNoteInputSubmit.bind(this) });
		this.display = new _NoteDisplay.NoteDisplay(this.data);
	...
	_createClass(Note, [{
		...
		key: 'insertNote',
		value: function insertNote(container) {
			this.render();
			container.append(this.el);
		}
	}, {
		key: 'onNoteInputSubmit',
		value: function onNoteInputSubmit(item) {
...
var NoteInput = exports.NoteInput = function () {
	function NoteInput(_ref) {
	...
	_createClass(NoteInput, [{
		...
		value: function _onSubmit(e) {
			...
			var event = new Event('displaySubmit', { bubbles: true });
			event.submit = { item: {
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../node_modules/css-loader/index.js!./noteinput.css", function() {
			var newContent = require("!!../../node_modules/css-loader/index.js!./noteinput.css");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
// module
exports.push([module.i, ".noteinput_form {\r\n\r\n}\r\n.noteinput_form .form__name {\r\n\r\n}\r\n.noteinput_form .form__text {\r\nwidth: 100%;\r\n}\r\n.noteinput_form .form__submit {\r\n\r\n}", ""]);
...
var NoteDisplay = exports.NoteDisplay = function () {
	...
	_createClass(NoteDisplay, [{
		...
		value: function getHTML() {
			return this.data.map(function (message) {
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../node_modules/css-loader/index.js!./notedisplay.css", function() {
			var newContent = require("!!../../node_modules/css-loader/index.js!./notedisplay.css");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
// module
exports.push([module.i, ".notedisplay {\r\n\tpadding: 0.6rem;\r\n}\r\n.notedisplay .nodedisplay__note {\r\nborder-bottom: 1px solid grey;\r\npadding-top: 1rem;\r\n}\r\n.notedisplay .note__name {\r\nfont-weight: bold;\r\n}\r\n.notedisplay .note__text {\r\n\r\n}", ""]);
